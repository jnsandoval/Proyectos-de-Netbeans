...
public class DirectorDepartamento extends Empleado {
    ...
    public DirectorDepartamento(String nombre, int codigo) {
        super(nombre, codigo);
    }

    @Override
    public void realizarActividad(String prefijo) {
    System.out.println(prefijo + "Director de Departamento " + nombre + " ejecuta actividad 2");
    ...
    public void ObtenerSubalternos() {
        for (Empleado e : listaSubalternos) {
            System.out.println("Subalterno de DirectorDepartamento: " + e.nombre);
        }
    }
